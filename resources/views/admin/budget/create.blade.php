            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('admin.budgets.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="date" name="date_limite" id="date_limite" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('date_limite') }}">
