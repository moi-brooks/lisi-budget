...
<head>
    <meta charset="UTF-8">
    <title>Export des Propositions</title>
    <style>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 25%">Ligne Originale</th>
                <th class="right" style="width: 10%">Montant</th>
        ...
        <tbody>
            @foreach($propositions as $row)
                <tr>
                    ...
                    <td>{{ mb_strimwidth($row['Ligne Originale'], 0, 30, '...') }}</td>
                    <td class="right"><strong>{{ $row['Montant (DH)'] }}</strong> DH</td>
                    <td class="
